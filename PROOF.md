...
lhs = mu<sub>d</sub> . (T<sub>m</sub> h . (mu<sub>c</sub> . (T<sub>m</sub> g . f)))
    ...
    = mu<sub>d</sub> . T<sub>m</sub> mu<sub>d</sub> . T<sub>m</sub> (T<sub>m</sub> h . g) . f        [ mu<sub>T<sub>o</sub> d</sub> = T mu<sub>d</sub> i.e., associativity of functor composition; and functor presevers composition ]
