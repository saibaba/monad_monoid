...
An example of mappend that is not associative: The captious answer https://stackoverflow.com/questions/15054765/how-do-you-implement-monoid-interface-for-this-tree-in-haskell
'Branch (Branch a b) c' is different tree than 'Branch a (Branch b c)'.
